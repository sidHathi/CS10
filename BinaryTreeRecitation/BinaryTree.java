...
public class BinaryTree<E> {
	...
	public BinaryTree<E> shallowCopy(int depth) throws Exception{
		...
		if (depth == 0){
			...
			leftCopy = left.shallowCopy(depth-1);
			rightCopy =  right.shallowCopy(depth-1);
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			System.out.println("At depth 1:");
			System.out.println(root.shallowCopy(1));
		} catch (Exception e) {
			e.printStackTrace();
		}
