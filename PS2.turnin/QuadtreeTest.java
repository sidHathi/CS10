...
public class QuadtreeTest {
	...
	/**
	 * Tests to ensure that the pointlist generated by the quadtree has all the points in the tree
	 * @param tree
	 * @param dots
	 * @return
	 */
	private static int testPointList(PointQuadtree<Dot> tree, List<Dot> dots){
		int errs = 0;

		if (tree.size() != dots.size()){
			System.err.println("Sizes do not match. Expected :" + tree.size() + "got: " + dots.size());
			errs++;
		}
	...
	private static void test2(){
		PointQuadtree<Dot> tree = new PointQuadtree<Dot>(new Dot(0,0, "A"), -1000,-1000,1000,1000);
		...
		int bad = testPointList(tree, allPoints);
